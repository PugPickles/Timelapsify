    ...
    <timt_img_cal id="timt_img_cal">
        ...
        <table style="margin: auto;">
            <tr>
                ...
                <td>
                    <input type="number" placeholder="Images" id="cal_images_total">
                </td>
            </tr>
            <tr>
                <td style="text-align: center; white-space: nowrap;">
                ...
                <td>
                    <input type="time" id="cal_timer_total" min="00:00:05" step="1">
                </td>
            </tr>
        </table>
...
<script>
    ...
    document.getElementById("start_cal").addEventListener("click", function () {
        let images = document.getElementById("cal_images_total").value;
        let time = document.getElementById('cal_timer_total').value.split(":")
        ...
        if (images == "") {
            document.getElementById('cal_images_total').style.border = "1px solid #f33";
            return;

        } else {
            document.getElementById('cal_images_total').style.border = "1px solid #dfdfdf";
        }

        if (s == undefined) {
            document.getElementById('cal_timer_total').style.border = "1px solid #f33";
            return;

        } else {
            document.getElementById('cal_timer_total').style.border = "1px solid #dfdfdf";
        }

        let time_s = Math.floor((h * 3600) + (m * 60) + parseFloat(s));

        let t_img_timer = time_s / images;

        document.getElementById('timer').value = Number.parseFloat(t_img_timer).toFixed(0);
